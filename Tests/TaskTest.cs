...
namespace ToDoList
{
  public class ToDoTest : IDisposable
  {
    ...
    {
      //Arrange, Act
      Task firstTask = new Task("Mow the lawn", new DateTime(2016, 7, 16));
      Task secondTask = new Task("Mow the lawn", new DateTime(2016, 7, 16));
    ...
    public void Test_Delete_DeletesTaskAssociationsFromDatabase()
    {
      ...
      Task testTask = new Task(testDescription, new DateTime(2016, 7, 16));
      testTask.Save();
